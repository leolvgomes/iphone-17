import design from "/img/titanium-design.jpg"
import features from "/img/ios-features.jpg"
import chip from "/img/chip-a18-pro.jpg"
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-zinc-950 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={design} alt="iphone-titanium" />
                    ...
                    <div className="bg-zinc-950 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={features} alt="ios-26" />
                ...
                <div className="bg-zinc-950 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src={chip} alt="chip-a18"></img>
